...
#         - Month, an index from 0 (January) to 11 (December)* 較麻煩
#         - OperatingSystems, an integer
#         - Browser, an integer
#         - Region, an integer
#         - TrafficType, an integer
#         - VisitorType, an integer 0 (not returning) or 1 (returning)* 如果是"Returning_Visitor"則換成1，其他為0
#         - Weekend, an integer 0 (if false) or 1 (if true) >> 可直接用int()轉換
...
#                     int(row[13]),
#                     int(row[14]),
#                     # 如果是"Returning_Visitor"則換成1，其他為0
